...
$introposition = $this->item->jcFields["intropositie"]->rawvalue;
$circle = $this->item->jcFields["circle"]->rawvalue;
...
<div class="article <?php echo $introposition[0] . " " . $circle; ?>"<?php if (
